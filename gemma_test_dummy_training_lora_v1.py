...
tokenizer = AutoTokenizer.from_pretrained('/home/bob/gemma/', use_fast=True)
...
training_args = TrainingArguments(
    ...
    num_train_epochs=3,
    per_device_train_batch_size=2,    #I used two for this when it succeeded
...
model.save_pretrained('./fine-tuned-gemma-noquant')
tokenizer.save_pretrained('./fine-tuned-gemma-noquant')